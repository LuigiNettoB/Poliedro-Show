...
class Perguntas(BaseFrame):
    def __init__(self, parent, controller):
        ...
        self.pack_propagate(0)
        self.controller = controller
        self.banco = self.controller.banco
        self.fonte = ("fixedsys",22,"bold")
    ...
    def criar_tela_materia(self): 
        ...
        self.btn_iniciar_jogo = CTkButton(master=self, text="Iniciar", font=("fixedsys",22,"bold"),width=300,height=100,command=self.iniciar_jogo)
        self.btn_iniciar_jogo.grid(column=0,row=3,padx=400,pady=10)


    def iniciar_jogo(self):
        self.destroy()
        return self.criar_tela()
